...
you have your self energy already stored as a real-frequency :class:`BlockGf <triqs.gfs.BlockGf>` object
in a hdf5 file::
...
into a real-frequency :class:`ReFreqGf <triqs.gfs.ReFreqGf>` object. Loading each block separately and
building up a :class:´BlockGf <triqs.gfs.BlockGf>´ is done with::
